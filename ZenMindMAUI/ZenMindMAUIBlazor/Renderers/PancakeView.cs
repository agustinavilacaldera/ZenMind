  ...
  public class PancakeView : ContentView
    {
        ...
        public static readonly BindableProperty BackgroundGradientStopsProperty = BindableProperty.Create(nameof(BackgroundGradientStops), typeof(ZenMind.Styles.GradientStopCollection), typeof(PancakeView), defaultValue: default(ZenMind.Styles.GradientStopCollection),
        defaultValueCreator: bindable =>
        {
            return new ZenMind.Styles.GradientStopCollection();
        });
        ...
        public static readonly BindableProperty BorderGradientStopsProperty = BindableProperty.Create(nameof(BorderGradientStops), typeof(ZenMind.Styles.GradientStopCollection), typeof(PancakeView), defaultValue: default(ZenMind.Styles.GradientStopCollection),
        defaultValueCreator: bindable =>
        {
            return new ZenMind.Styles.GradientStopCollection();
        });
        ...
        public ZenMind.Styles.GradientStopCollection BackgroundGradientStops
        {
            get { return (ZenMind.Styles.GradientStopCollection)GetValue(BackgroundGradientStopsProperty); }
        ...
        public ZenMind.Styles.GradientStopCollection BorderGradientStops
        {
            get { return (ZenMind.Styles.GradientStopCollection)GetValue(BorderGradientStopsProperty); }
